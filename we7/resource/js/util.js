...
util.getWe7User = function (cb, code) {
	...
	util.request({
        ...
        userInfo.uid = session.data.data.uid
...
util.getWe7UserV2 = function(code,cb){
  let userInfo = wx.getStorageSync('userInfo')
  console.log(code);
  util.request({
    // url: 'auth/session/getuser',
    url:'entry/wxapp/getuser',
		data: {
      userInfo: userInfo,
      openid:userInfo.memberInfo.openid,
      code:code,
...
util.getUserInfo = function (cb, wxInfo) {
	var login = function() {
        ...
        let code = res.code;
          ...
          util.getWe7UserV2(code,function(){
            typeof cb == "function" && cb(userInfo);
          })
					...
					// 	})
					// } else {
          //   util.getWe7UserV2(res,function)
          //   console.log(ret);
          //   return;  
